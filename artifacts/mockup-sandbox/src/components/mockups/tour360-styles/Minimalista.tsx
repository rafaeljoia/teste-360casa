    ...
    <div className="w-[1280px] h-[720px] relative overflow-hidden bg-zinc-50 font-sans select-none flex items-center justify-center">
            ...
            <button
              ...
              style={
                activeScene === scene.id
                  ? { background: "white", color: GOLD, boxShadow: "0 1px 4px rgba(0,0,0,0.08)" }
                  : { color: "#52525b" }
              }
            >
              {scene.name}
      ...
      <div className="absolute bottom-10 left-10">
        <div className="bg-white/60 backdrop-blur-xl px-7 py-5 rounded-3xl border border-white/80 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.08)] flex flex-col gap-1 max-w-sm">
          ...
          <p className="text-sm text-zinc-500 mt-2 leading-relaxed">
            Experience the seamless flow of light and space in this elegantly minimalist design.
          </p>
        </div>
      </div>
      ...
      <div className="absolute bottom-12 left-1/2 -translate-x-1/2">
        <button
          ...
          className="flex items-center justify-center w-16 h-16 bg-white/70 backdrop-blur-xl rounded-full border border-white/80 shadow-[0_8px_24px_-8px_rgba(0,0,0,0.1)] hover:bg-white hover:scale-105 transition-all duration-300 focus:outline-none"
          style={{ color: GOLD }}
        >
          {isPlaying ? (
      ...
      <div className="absolute bottom-10 right-10 flex gap-4">
        ...
        <div className="flex flex-col gap-2 bg-white/60 backdrop-blur-xl p-2 rounded-2xl border border-white/80 shadow-[0_8px_24px_-8px_rgba(0,0,0,0.08)]">
          <button
            className="p-3 rounded-xl text-zinc-600 hover:bg-white/80 transition-colors focus:outline-none"
        ...
        <div className="grid grid-cols-3 grid-rows-3 gap-1 bg-white/60 backdrop-blur-xl p-2 rounded-2xl border border-white/80 shadow-[0_8px_24px_-8px_rgba(0,0,0,0.08)]">
          <div />
          <button className="p-2 rounded-xl text-zinc-600 hover:bg-white/80 transition-colors flex items-center justify-center focus:outline-none">
          ...
          <button className="p-2 rounded-xl transition-colors flex items-center justify-center focus:outline-none" style={{ color: GOLD }}>
      ...
      {/* Style Label */}
      <div className="absolute top-8 left-8 bg-white/70 backdrop-blur-xl px-4 py-2 rounded-full border border-white/80">
